...
public class NanoRefineryOld
{
    public NanoRefineryOld (Vector<Reaction> reactions, boolean debug)
    {
        _debug = debug;
    ...
    public final int oreNeeded ()
    {
        ...
        if (fuel != null)
        {
            ...
            while (iter.hasMoreElements())
                System.out.println("**GOT "+iter.nextElement());
                
            oreNeeded = createNeededAmount(fuelChemicalQuantities);
        }
        else
