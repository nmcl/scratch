...
public class dumbo_octopus {
    ...
    public static void simulateOctopuses(String filename) {
        try {
            ...
            int totalOctopuses = rows * cols;
            
            System.out.println("Before any steps:");
            printGrid(grid);
            System.out.println("Total octopuses: " + totalOctopuses);
            System.out.println();
            
            // Part 1: Simulate 100 steps and count flashes
            int totalFlashes = 0;
            int synchronizedStep = -1;
            
            System.out.println("PART 1: Counting flashes for 100 steps");
            System.out.println("======================================================================");
            ...
            for (int step = 1; step <= STEPS; step++) {
                ...
                // Check if all octopuses flashed (synchronized)
                if (flashes == totalOctopuses && synchronizedStep == -1) {
                ...
                if (step <= 10 || step % 10 == 0) {
                    ...
                    if (flashes == totalOctopuses) {
                        System.out.println("*** ALL OCTOPUSES SYNCHRONIZED! ***");
                    }
                    System.out.println();
                }
            }
            ...
            System.out.println("PART 2: Finding synchronized flash");
            System.out.println("======================================================================");
            
            if (synchronizedStep != -1) {
                System.out.println("All octopuses synchronized at step: " + synchronizedStep);
            } else {
                System.out.println("Continuing simulation to find synchronized flash...");
                System.out.println();
                ...
                while (step <= maxSteps) {
                    ...
                    if (step % 50 == 0) {
                        System.out.println("Checked up to step " + step + "...");
                    }
                ...
                if (synchronizedStep == -1) {
                    System.out.println("No synchronized flash found within " + maxSteps + " steps.");
                }
            }
            ...
            System.out.println("======================================================================");
            System.out.printf("Part 1 - Total flashes after %d steps: %d%n", STEPS, totalFlashes);
            if (synchronizedStep != -1) {
                System.out.printf("Part 2 - First synchronized flash at step: %d%n", synchronizedStep);
            }
            System.out.println("======================================================================");
    ...
    public static void testWithExample() {
        ...
        // Part 1: Count flashes for 100 steps
        for (int step = 1; step <= STEPS; step++) {
            int flashes = simulateStep(grid);
            totalFlashes += flashes;
        ...
        // Part 2: Find synchronized flash
        if (synchronizedStep == -1) {
            int step = STEPS + 1;
            while (step <= 500 && synchronizedStep == -1) {
                int flashes = simulateStep(grid);
                
                if (flashes == totalOctopuses) {
                    synchronizedStep = step;
                    System.out.println("After step " + step + " (SYNCHRONIZED):");
                    printGrid(grid);
                    System.out.println();
                }
        ...
        System.out.println("Expected first synchronized flash: step 195");
        System.out.println("Actual first synchronized flash: step " + synchronizedStep);
        System.out.println("======================================================================");
    }
}