...
public class PlanetVisualizationResource {
    ...
    private String generateHtmlContent() {
        ...
        html.append("case 0: return ['#1a73e8', '#388e3c', '#5d4037']; // Earth-like");
        html.append("case 1: return ['#ff9800', '#ff5722', '#795548']; // Desert");
        html.append("case 2: return ['#b3e5fc', '#e1f5fe', '#e0f7fa']; // Ice world");
        html.append("case 3: return ['#2e7d32', '#4caf50', '#1b5e20']; // Forest world");
        ...
        html.append("gradient.addColorStop(0, atmosphereColor + '80'); // Semi-transparent");
        html.append("gradient.addColorStop(1, atmosphereColor + '00'); // Transparent");
        html.append("ctx.beginPath();");
